...
function MoviesCard({ link, name, duration, isLiked, hasDelete, onCardLike, onCardDelete, trailerLink }) {
    ...
    return (
        <div className="movies-card">
            ...
            {!hasDelete && isLiked && <button type="button" onClick={onCardDelete} className="movies-card__toogl"><img alt="Сохранено" src={save} /></button>}
            {!hasDelete && !isLiked && <button type="button" onClick={onCardLike} className="movies-card__save">Сохранить</button>}
